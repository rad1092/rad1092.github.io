...
:root {
  ...
  --text: #ededef;
  --muted: #9a9aa2;
  --accent: #d8ff3e;        /* A24-ish acid highlight */
  --accent-ink: #0e0e10;
...
/* about */
.about-head { font-family: var(--serif); font-size: 3rem; font-weight: 700; letter-spacing: -.025em; line-height: 1.16; max-width: 17ch; margin: 0 0 28px; }
...
.summary { color: var(--text); margin: 0 0 16px; font-size: 1.35rem; line-height: 1.5; font-weight: 500; letter-spacing: -.01em; max-width: 32ch; }
...
<div class="app">
  ...
  <aside class="rail">
    <div>
      ...
      <nav class="rail-nav">
        <a class="rail-link active" href="#about"><span class="bar"></span> 소개</a>
        <a class="rail-link" href="#experience"><span class="bar"></span> 경력 · 이력</a>
        <a class="rail-link" href="#p1"><span class="bar"></span> 재난 대피 대시보드</a>
        <a class="rail-link" href="#p2"><span class="bar"></span> FirstCall</a>
        <a class="rail-link" href="#p3"><span class="bar"></span> gh-dep-risk</a>
        <a class="rail-link" href="#more"><span class="bar"></span> 그 외 작업</a>
        <a class="rail-link" href="#contact"><span class="bar"></span> 연락</a>
      </nav>
    </div>
    <div class="rail-foot">
  ...
  <main class="view">
    ...
    <section class="view-panel active" id="about">
      ...
      <h1 class="about-head">현장 영업·납품을 거쳐, 사람의 <span class="hl">다음 한 걸음</span>을 돕는 소프트웨어를 만듭니다.</h1>
      <p class="lead">
