...
- 🐍 **Python 중심**으로 AI, 자동화, 데이터 시각화 프로젝트를 수행했습니다.
- ⚙️ **개발 생산성** 주제 (GitHub Actions, 의존성 보안 점검, API 도구화 등)에 깊은 관심을 가지고 있습니다.
- 🌱 실험적인 저장소부터 실제 도구형 프로젝트까지 단계적으로 확장해 왔습니다.

🔗 **[깃허브 저장소 전체 목록 보기](/repositories/)**
...
<details>
<summary><strong>자세히 보기 (설명 및 데모)</strong></summary>

- **기술 스택**: Rust 2024, Tauri, React
...
- **기술 스택**: Go, GitHub CLI, GitHub Actions
