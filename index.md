...
<section class="hero">
  ...
  <div class="intro">
    ...
    <h1>김홍대 <span style="color:var(--muted);font-size:1.3rem;">HongDae Kim</span></h1>
    <p class="role">개발 생산성 · 자동화 · 데이터 시각화에 집중하는 개발자</p>
    <div class="cta">
...
<section class="section" id="about">
  ...
  <p class="lead">
    실험적인 학습 저장소에서 시작해 실제 사용 가능한 도구형 프로젝트까지 단계적으로 확장해 왔습니다.
    <b style="color:var(--text)">"정보 전달을 넘어 실제 행동을 돕는다"</b>는 관점으로,
    API 도구화 · 의존성 보안 점검 · 재난 대피 안내처럼 사용자의 다음 한 걸음을 만들어 주는 소프트웨어를 만듭니다.
  </p>
  <div class="chips">
    ...
    <span class="chip"><b>관심사</b> · 개발 생산성 · 보안 · 자동화</span>
  </div>
</section>

<!-- ============ PROJECTS ============ -->
<section class="section" id="projects">
  <h2><span class="num">02.</span> 주요 프로젝트</h2>
  <p class="lead" style="margin-bottom:8px;">각 프로젝트는 <span class="mono" style="color:var(--accent)">STAR</span> — 상황(Situation) · 과제(Task) · 행동(Action) · 결과(Result) — 로 정리했습니다. 탭을 눌러 살펴보세요.</p>
  ...
  <article class="project" id="p1">
    ...
    <p class="summary">curl·OpenAPI·Postman·HAR 등 다양한 요청 소스를 <b style="color:var(--text)">로컬에서 검증</b>하고, 검증된 것만 비밀정보를 가린(redacted) <b style="color:var(--text)">에이전트 패키지</b>로 내보내는 데스크톱 + CLI 워크벤치.</p>
    ...
    <div class="tabs" role="tablist">
      <button class="tab-btn active" data-target="p1-s"><span class="k">S</span>상황</button>
      <button class="tab-btn" data-target="p1-t"><span class="k">T</span>과제</button>
      <button class="tab-btn" data-target="p1-a"><span class="k">A</span>행동</button>
      <button class="tab-btn" data-target="p1-r"><span class="k">R</span>결과</button>
    </div>
  ...
  <article class="project" id="p2">
    ...
    <p class="summary">리뷰어가 <b style="color:var(--text)">필요할 때만 실행</b>해 PR에 추가된 의존성의 보안 리스크를 요약하는 GitHub CLI 확장. 서버·웹훅·DB 없이 <b style="color:var(--text)">단일 Go 바이너리</b>로 동작.</p>
    ...
    <div class="tabs" role="tablist">
      <button class="tab-btn active" data-target="p2-s"><span class="k">S</span>상황</button>
      <button class="tab-btn" data-target="p2-t"><span class="k">T</span>과제</button>
      <button class="tab-btn" data-target="p2-a"><span class="k">A</span>행동</button>
      <button class="tab-btn" data-target="p2-r"><span class="k">R</span>결과</button>
    </div>
  ...
  <article class="project" id="p3">
    ...
    <p class="summary">재난문자는 <b style="color:var(--text)">발생 사실</b>만 알려줍니다. "지금 어디로, 어떻게 대피해야 하는지"까지 안내하기 위해 — 위치 기반 대피소 추천 · 경로 안내 · 지역별 재난 패턴 분석을 하나로 묶은 멀티페이지 대시보드.</p>
    ...
    <div class="tabs" role="tablist">
      <button class="tab-btn active" data-target="p3-s"><span class="k">S</span>상황</button>
      <button class="tab-btn" data-target="p3-t"><span class="k">T</span>과제</button>
      <button class="tab-btn" data-target="p3-a"><span class="k">A</span>행동</button>
      <button class="tab-btn" data-target="p3-r"><span class="k">R</span>결과</button>
    </div>
...
<section class="section contact" id="contact">
  <h2 style="justify-content:center;"><span class="num">03.</span> 연락</h2>
